...
\begin{figure}
	\centering
    \movie[height=6cm,poster]{Le film ne s'affichera pas dans ce lecteur pdf}{film_col.avi}
...
\renewcommand{\figurename}{Film}
	\centering
	\movie[height=6cm,poster]{Le film ne s'affichera pas dans ce lecteur pdf}{film_bac.avi}
